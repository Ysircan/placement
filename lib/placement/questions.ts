...
export const questions: QuestionBank = {
  vocabulary: [
    ...
    },
    {
      ...
      difficulty: "C",
      prompt:
        "Which word describes a position based on evidence rather than personal feelings?",
      options: [
        { id: "a", text: "emotional" },
    ...
    },
    {
      ...
      difficulty: "C",
      prompt:
        "The report provides a ___ analysis of the issue, covering all major factors.",
      options: [
        { id: "a", text: "complete" },
